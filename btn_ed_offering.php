...
if (isset($_POST['id']) && isset($_POST['Offering_day']) && isset($_POST['Offering_amount'])) {
    
    // Sanitize the input to prevent SQL injection
    $id = intval($_POST['id']);
    $day = $conn->real_escape_string($_POST['Offering_day']);
    $amount = $conn->real_escape_string($_POST['Offering_amount']);
    
    // Prepare the UPDATE statement
    $sql = "UPDATE add_offering SET day=?, amount=? WHERE id=?";
